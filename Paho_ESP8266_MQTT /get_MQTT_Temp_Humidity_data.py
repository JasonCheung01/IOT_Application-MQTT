# What this program does is subscribe to the ESP8266 topic and be able to receive
# sensor data (specifically the temp/humidity sensor)  
...
MQTT_topic_humidity = 'room/+';  
MQTT_topic_temperature = 'room/+/+'; 
